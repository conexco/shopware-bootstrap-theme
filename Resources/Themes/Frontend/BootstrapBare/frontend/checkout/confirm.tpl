...
{block name="frontend_index_content"}
    ...
    {block name='frontend_checkout_confirm_personal_information'}
        <h2 class="mb-4">{s name="ConfirmHeadlinePersonalInformation"}Ihre pers&ouml;nlichen Informationen{/s}</h2>
                ...
                {block name='frontend_checkout_confirm_information_addresses'}
                    {if $activeBillingAddressId == $activeShippingAddressId}
                        ...
                        {block name='frontend_checkout_confirm_information_addresses_equal'}
                            <div class="col-lg-8 mb-4" id="confirm-billing-shipping-address">
                            ...
                            {block name='frontend_checkout_confirm_information_addresses_equal_panel'}
                                {block name='frontend_checkout_confirm_information_addresses_equal_panel_title'}
                                    <div class="card-header bg-transparent">{s name='ConfirmAddressEqualTitle'}Rechnungsadresse & Lieferadresse{/s}</div>
                                {/block}
                                <div class="row card-body d-flex">
                                    ...
                                    <div class="col-lg-6 pr-lg-0">
                                        ...
                                        {block name="frontend_checkout_confirm_information_addresses_equal_panel_billing_invalid_data"}
                                            {if $invalidBillingAddress}
                                                {$confirmAddressInvalidAddress = ''|snippet:'ConfirmAddressInvalidAddress':'frontend/checkout/confirm':''}
                                                {include file='frontend/_includes/messages.tpl' type="warning" content=$confirmAddressInvalidAddress}
                                            {else}
                                                    ...
                                                    {if $activeBillingAddressId != $sUserData.additional.user.default_billing_address_id || $activeShippingAddressId != $sUserData.additional.user.default_shipping_address_id}
                                                        <div>
                                                            <label for="set_as_default" class="checkbox-inline">
                                                                <input name="setAsDefaultAddress" type="checkbox"
                                                                       id="set_as_default" value="1"/>
                                    ...
                                    {block name='frontend_checkout_confirm_information_addresses_equal_panel_shipping'}
                                        <div class="col-md-6 pl-lg-0 text-lg-right">
                                ...
                                <div class="col-lg-4 mb-4">
                                    <div id="confirm-show-payment" class="card h-100">
                                        {block name='frontend_checkout_confirm_dispatch_payment_method_row'}
                                            ...
                                            {block name='frontend_checkout_confirm_payment_method_panel'}
                                                ...
                                                {block name='frontend_checkout_confirm_left_payment_method_headline'}
                                                    <div class="card-header bg-transparent">{s name="ConfirmHeaderPaymentShipping" namespace="frontend/checkout/confirm"}{/s}</div>
                                                {/block}
                                                ...
                                                {block name='frontend_checkout_confirm_left_payment_method_actions'}
                                                    <div class="align-self-start mt-auto">
                                                        <a href="{url controller=checkout action=shippingPayment sTarget=checkout}"
                                                           class="btn btn-sm btn-outline-primary align-self-start mt-auto mb-2">
                    ...
                    {else}
                        ...
                        {block name='frontend_checkout_confirm_information_addresses_billing'}
                            <div class="col-lg-8 mb-4" id="confirm-billing-address">
                            <div class="card h-100">
                            <div class="row">
                            {* Billing address *}
                            {block name='frontend_checkout_confirm_information_addresses_billing_panel'}
                                ...
                                {block name='frontend_checkout_confirm_information_addresses_billing_panel_title'}
                                    <div class="col-lg-6 pr-lg-0  d-flex flex-column">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        {block name="frontend_checkout_confirm_information_addresses_billing_panel_body_invalid_data"}
                                            {if $invalidBillingAddress}
                                                ...
                                                {$confirmAddressInvalidBillingAddress = ''|snippet:'ConfirmAddressInvalidBillingAddress':'frontend/checkout/confirm':''}
                                                {include file='frontend/_includes/messages.tpl' type="warning" content=$confirmAddressInvalidBillingAddress}
                                                    ...
                                                    {if $activeBillingAddressId != $sUserData.additional.user.default_billing_address_id}
                                                        <div>
                                                            <label for="set_as_default_billing" class="checkbox-inline">
                                                                <input name="setAsDefaultBillingAddress" type="checkbox"
                                                                       id="set_as_default_billing" value="1"/>
                                                ...
                                                <div class="align-self-start mt-auto">
                                                    ...
                                                    {block name="frontend_checkout_confirm_information_addresses_billing_panel_actions_select_address"}
                                                        <a href="{url controller=address}"
                                                           ...
                                                           class="btn btn-outline-secondary btn-sm align-self-start mt-auto mb-2">
                                                            {s name="ConfirmAddressSelectLink"}{/s}
                                                        </a>
                                                    {/block}
                                                </div>
                        ...
                        {block name='frontend_checkout_confirm_information_addresses_shipping'}
                            <div class="col-lg-6 pl-lg-0 d-flex flex-column" id="confirm-shipping-address">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <address class="card-text">
                                            {if $sUserData.shippingaddress.company}
                                                <strong>{$sUserData.shippingaddress.company|escapeHtml}{if $sUserData.shippingaddress.department|escapeHtml}
                                                        <br/>
                                                        {$sUserData.shippingaddress.department|escapeHtml}{/if}</strong>
                                                <br/>
                                            {/if}
                                            {$sUserData.shippingaddress.salutation|salutation}
                                            {if {config name="displayprofiletitle"}}
                                                {$sUserData.shippingaddress.title|escapeHtml}
                                                <br/>
                                            {/if}
                                            {$sUserData.shippingaddress.firstname|escapeHtml} {$sUserData.shippingaddress.lastname|escapeHtml}
                                            <br/>
                                            {$sUserData.shippingaddress.street|escapeHtml}<br/>
                                            {if $sUserData.shippingaddress.additional_address_line1}{$sUserData.shippingaddress.additional_address_line1|escapeHtml}
                                                <br/>
                                            {/if}
                                            {if $sUserData.shippingaddress.additional_address_line2}{$sUserData.shippingaddress.additional_address_line2|escapeHtml}
                                                <br/>
                                            {/if}
                                            {if {config name=showZipBeforeCity}}{$sUserData.shippingaddress.zipcode|escapeHtml} {$sUserData.shippingaddress.city|escapeHtml}{else}{$sUserData.shippingaddress.city|escapeHtml} {$sUserData.shippingaddress.zipcode|escapeHtml}{/if}
                                            <br/>
                                            {if $sUserData.additional.stateShipping.name}{$sUserData.additional.stateShipping.name|escapeHtml}
                                                <br/>
                                            {/if}
                                        ...
                                        {block name="frontend_checkout_confirm_information_addresses_shipping_panel_body_invalid_data"}
                                            {if $invalidShippingAddress}
                                                {$confirmAddressInvalidShippingAddress = ''|snippet:'ConfirmAddressInvalidShippingAddress':'frontend/checkout/confirm':''}
                                                {include file='frontend/_includes/messages.tpl' type="warning" content=$confirmAddressInvalidShippingAddress}
                                            {else}
                                                    ...
                                                    {if $activeShippingAddressId != $sUserData.additional.user.default_shipping_address_id}
                                                        <div>
                                                            <label for="set_as_default_shipping"
                                                                ...
                                                                <input name="setAsDefaultShippingAddress"
                                                                       type="checkbox"
                                                                       id="set_as_default_shipping" value="1"/>
                                                                {s name='ConfirmUseForFutureOrders'}{/s}
                                                            </label>
                                                        </div>
                                                    {/if}
    ...
    {block name='frontend_checkout_confirm_tos_panel'}
        <div class="mb-4" id="confirm-tos">
            <div class="card">
                {block name='frontend_checkout_confirm_tos_panel_headline'}
                    <div class="card-header bg-transparent">{s name="ConfirmHeadlineAGBandRevocation"}AGB und Widerrufsbelehrung{/s}</div>
                {/block}
                                        ...
                                        <div class="checkbox">
                                            <label for="esdAgreementChecked"{if $agreementErrors && $agreementErrors.esdError} class="text-danger"{/if}>
                                                ...
                                                {block name='frontend_checkout_confirm_esd_checkbox'}
                                                    <input type="checkbox" name="esdAgreementChecked"
                                                           required="required"
                                                           aria-required="true"
        ...
        {if {config name=commentvoucherarticle}||{config name=bonussystem} && {config name=bonus_system_active} && {config name=displaySlider}}
            ...
            {if {config name=commentvoucherarticle}}
                {block name="frontend_checkout_confirm_voucher_addarticle_panel"}
                    <div class="col-lg-6">
                        <div>{s name="ConfirmHeadlineAdditionalOptions"}Weitere Optionen{/s}</div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            {block name='frontend_checkout_confirm_add_voucher_field'}
                                                {$checkoutFooterAddVoucherLabelInline = ''|snippet:'CheckoutFooterAddVoucherLabelInline':'frontend/checkout/cart_footer':'|escape'}
                                                <input type="text" class="form-control" id="basket_add_voucher"
                                                       name="sVoucher"
                                                       placeholder="{$checkoutFooterAddVoucherLabelInline}"/>
                                            {/block}
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            {block name='frontend_checkout_confirm_add_product_field'}
                                                <input id="basket_add_article" name="sAdd" type="text"
                ...
                {block name="frontend_checkout_confirm_comment_panel"}
                    <div class="col-lg-6">
                        ...
                        {block name='frontend_checkout_confirm_comment'}
                            <div class="card">
                                <div class="card-body">
                                    <div>{s name="CheckoutCommentHeadline"}Kommentar{/s}</div>
                                    <div class="panel-wrapper" data-equal="additionalrow">
                        ...
                        {block name='frontend_checkout_confirm_confirm_table_actions'}
                                ...
                                {block name='frontend_checkout_confirm_submit'}
                                    <div class="text-right mb-4">
                                        ...
                                        {if $sPayment.embediframe || $sPayment.action}
                                            <button type="submit" class="btn btn-primary btn-lg mb-2" form="confirmForm"
                            ...
                            {else}
                                {block name='frontend_checkout_confirm_stockinfo'}
                                    ...
                                    {$confirmErrorStock = 'Ein Artikel aus Ihrer Bestellung ist nicht mehr verfügbar! Bitte entfernen Sie die Position aus dem Warenkorb!'|snippet:'ConfirmErrorStock':'frontend/checkout/confirm':''}
                                    {include file="frontend/_includes/messages.tpl" type="danger" content=$confirmErrorStock}
                                {/block}
                            {/if}
                        {/block}
                    </div>
