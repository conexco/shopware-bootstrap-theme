                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        {block name="frontend_index_menu_footer_service_line_inner"}
                            ...
                            {block name="frontend_index_footer_column_service_hotline_content"}
                                <div class="mb-2">
                                    {s name="sFooterServiceHotline"}Telefonische Unterst&uuml;tzung und Beratung unter:<br/><br/><strong>0180 - 000000</strong><br/>Mo-Fr, 09:00 - 17:00 Uhr{/s}
                                </div>
                            {/block}
                        {/block}
                    </div>
                        ...
                        {block name="frontend_index_menu_footer_newsletter_inner"}
                            ...
                            {block name="frontend_index_footer_column_newsletter_content"}
                                ...
                                {block name="frontend_index_footer_column_newsletter_form"}
                                    <form action="{url controller='newsletter'}" class="mb-2" method="post">
                                        ...
                                        {block name="frontend_index_footer_column_newsletter_form_field"}
                                            <div class="input-group">
                                                <input type="email" 
                                                       class="form-control" 
                                                       name="newsletter" 
                                                       aria-label="{s name='sFooterNewsletterHead'}{/s}" 
                                                       placeholder="{s name="IndexFooterNewsletterValue"}Ihre E-Mail Adresse{/s}"/>
                                                ...
                                                {block name="frontend_index_footer_column_newsletter_form_submit"}
                                                    <span class="input-group-btn">
                                                        <button type="submit" 
                                                                ...
                                                                aria-label="{s name='IndexFooterNewsletterSubmit'}{/s}">
