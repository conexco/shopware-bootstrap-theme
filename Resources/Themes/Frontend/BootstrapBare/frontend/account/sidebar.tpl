                        ...
                        {block name="frontend_account_offcanvas_button"}
                            <a href="#"
                               ...
                               title="{s name="AccountLinkTitle"}{/s}">
                                ...
                                <i class="fa fa-angle-right offcanvas-btn-angle mls"></i> </a>
                        {/block}
                    {/if}
                                        ...
                                        {block name="frontend_account_menu_list"}
                                            ...
                                            {block name="frontend_account_menu_link_overview"}
                                                {block name="frontend_account_menu_link_overview_SltCookie"}
                                                    {if {config name=useSltCookie} && !$userInfo && $inHeader}
                                                        <div class="navigation-entry list-group-item">
                                            ...
                                            {block name="frontend_account_menu_link_payment"}
                                                <a href="{url module='frontend' controller='account' action='payment'}"
                                                   ...
                                                   title="{s name="AccountLinkPayment"}Zahlungsart ändern{/s}"
                                                   rel="nofollow">
                ...
                <div id="accountSidebar" class="account-offcanvas offcanvas-has-panel">
                    ...
                    <div class="pvm phl">
                        {block name="frontend_account_menu_logout_onetimeaccount_link"}
                            <a href="{url controller='account' action='abort'}"
                               title="{s name='OneTimeOrderAbort'}{/s}"
                               class="link-abort">
                                {block name="frontend_account_menu_logout_onetimeaccount_link_text"}
                                    <i class="fa fa-sign-out" aria-hidden="true"></i>
                                    {s name="OneTimeOrderAbort"}{/s}
                                {/block}
                            </a>
                        {/block}
                    </div>
