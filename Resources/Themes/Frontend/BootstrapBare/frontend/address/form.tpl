        ...
        {block name="frontend_address_form_fieldset_customer_type"}
            <div class="form-group address-customertype sw5-plugin{if $error_flags.customer_type} has-error{/if}">
                {block name="frontend_address_form_fieldset_customer_type_select"}
                    <label for="register_personal_customer_type" class=" control-label">{s name='RegisterPersonalLabelType' namespace='frontend/register/personal_fieldset'}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</label>
            ...
            <div class="address-company collapse sw5-plugin">
                ...
                {block name='frontend_address_form_input_company'}
                    <div class="form-group address-companyname{if $error_flags.company} has-error{/if}">
                        <label for="register_billing_company" class=" control-label">{s name='RegisterPlaceholderCompany' namespace="frontend/register/billing_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</label>
                ...
                {block name='frontend_address_form_input_department'}
                    <div class="form-group address-department{if $error_flags.department} has-error{/if}">
                        <label for="register_billing_department" class=" control-label">{s name='RegisterLabelDepartment' namespace="frontend/register/billing_fieldset"}{/s}</label>
                ...
                {block name='frontend_address_form_input_vatid'}
                    <div class="form-group address-vatid{if $error_flags.vatId} has-error{/if}">
                        <label for="register_billing_vatid" class=" control-label">{s name='RegisterLabelTaxId' namespace="frontend/register/billing_fieldset"}{/s}{if {config name=vatcheckrequired}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}</label>
        ...
        {block name="frontend_address_form_fieldset_address"}
            ...
            {block name='frontend_address_form_input_salutation'}
                <div class="form-group address-salutation">
                    <label for="salutation" class=" control-label">{s name='RegisterPlaceholderSalutation' namespace="frontend/register/personal_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</label>
            ...
            {block name='frontend_register_personal_fieldset_input_title'}
                {if {config name="displayprofiletitle"}}
                    <div class="form-group register-title{if $error_flags.title} has-error{/if}">
                        <label for="title" class=" control-label">{s name='RegisterPlaceholderTitle' namespace="frontend/register/personal_fieldset"}{/s}</label>
            ...
            {block name='frontend_address_form_input_firstname'}
                <div class="form-group address-firstname{if $error_flags.firstname} has-error{/if}">
                    <label for="firstname2" class=" control-label">{s name='RegisterShippingPlaceholderFirstname' namespace="frontend/register/shipping_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</label>
            ...
            {block name='frontend_address_form_input_lastname'}
                <div class="form-group address-lastname{if $error_flags.lastname} has-error{/if}">
                    <label for="lastname2" class=" control-label">{s name='RegisterShippingPlaceholderLastname' namespace="frontend/register/shipping_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</label>
            ...
            {block name='frontend_address_form_input_street'}
                <div class="form-group address-street{if $error_flags.street} has-error{/if}">
                    <label for="street" class=" control-label">{s name='RegisterBillingPlaceholderStreet' namespace="frontend/register/billing_fieldset"}}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</label>
            ...
            {block name='frontend_address_form_input_addition_address_line1'}
                {if {config name=showAdditionAddressLine1}}
                    <div class="form-group address-additional-line1{if $error_flags.additionalAddressLine1 && {config name=requireAdditionAddressLine1}} has-error{/if}">
                        <label for="additionalAddressLine1" class=" control-label">{s name='RegisterLabelAdditionalAddressLine1'  namespace='frontend/register/shipping_fieldset'}{/s}{if {config name=requireAdditionAddressLine1}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}</label>
            ...
            {block name='frontend_address_form_input_addition_address_line2'}
                {if {config name=showAdditionAddressLine2}}
                    <div class="form-group address-additional-field2{if $error_flags.additionalAddressLine2 && {config name=requireAdditionAddressLine2}} has-error{/if}">
                        <label for="additionalAddressLine2" class=" control-label">{s name='RegisterLabelAdditionalAddressLine2'  namespace='frontend/register/shipping_fieldset'}{/s}{if {config name=requireAdditionAddressLine2}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}</label>
            ...
            {block name='frontend_address_form_input_zip_and_city'}
              <div class="address-zip-city form-group{if $error_flags.zipcode || $error_flags.city} has-error{/if}">
                  <label for="zipcode" class=" control-label">{s name='RegisterBillingPlaceholderZipcode' namespace='frontend/register/billing_fieldset'}{/s}{s name='RegisterBillingPlaceholderCityZipcodeDivider' namespace='frontend/register/billing_fieldset'}{/s}{s name='RegisterBillingPlaceholderCity' namespace='frontend/register/billing_fieldset'}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</label>
            ...
            {block name='frontend_address_form_input_country'}
                <div class="form-group address-country{if $error_flags.country} has-error{/if}">
                    <label for="country" class=" control-label">{s name='RegisterBillingPlaceholderCountry' namespace="frontend/register/billing_fieldset"}{/s}{s name="RequiredField" namespace="frontend/register/index"}{/s}</label>
                        ...
                        {block name="frontend_address_form_input_country_states_item"}
                            {if $country.states}
                                <div data-country-id="{$country.id}"
                                    ...
                                    <label for="country_{$country.id}_states" class=" control-label">{s name='RegisterBillingLabelState' namespace="frontend/register/billing_fieldset"}{/s}{if $country.force_state_in_registration}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}</label>
            ...
            {block name='frontend_address_form_input_phone'}
                {if {config name=showPhoneNumberField}}
                    <div class="address-phone form-group{if $error_flags.phone && {config name=requirePhoneField}} has-error{/if}">
                        <label for="phone" class=" control-label">{s name='RegisterPlaceholderPhone' namespace="frontend/register/personal_fieldset"}{/s}{if {config name=requirePhoneField}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}</label>
    ...
    <div class="form-group">
        <div>
            {block name="frontend_address_action_button_send"}
                <input type="submit" value="{s name="AddressesActionButtonSend"}Adresse speichern{/s}" class="btn btn-primary mb-2 address-form-submit"/>
            {/block}
        </div>
    </div>
{/block}
