{*! Default Grid Sizing *}
{block name="swrt_config_gridsizes"}
...
{block name="swrt_config_formsizes"}
...
{*! Breakpoints *}
{block name="swrt_config_breakpoints"}
...
{*! Background Image *}
{block name="swrt_config_background_image"}
