...
{block name="frontend_index_content_left_wrapper" prepend}
    {if $grid eq 'g110'}
        {assign "gridLeftStart" "&lt;div class=\"col-12 col-sm-push-{math equation="x-y" x=12 y=$theme['amount-left-columns']} col-sm-`$theme['amount-left-columns']`\" id=\"gLeft\"&gt;" scope="global"}
        {assign "gridCenterStart" "&lt;div class=\"col-12 col-sm-pull-{$theme['amount-left-columns']} col-sm-{math equation="x-y" x=12 y=$theme['amount-left-columns']}\" id=\"gCenter\"&gt;" scope="global"}
    {/if}
{/block}
