                    ...
                    <div class="col-xs-12 col-hd-6 col-lg-2 mbl mbn-lg">
                        ...
                        {if $sBasketItem.image.thumbnails[0]}
                            ...
                            <a href="{$detailLink}" title="{$sBasketItem.articlename|escape}">
                                <img srcset="{$sBasketItem.image.thumbnails[0].sourceSet}" alt="{$desc}" title="{$desc|truncate:160:""}" class="img-responsive img-center" />
                            </a>
                        {else}
                            <a href="{$detailLink}" title="{$sBasketItem.articlename|escape}">
                                    ...
                                    {if {config name="compareShow"}}
                                        <form action="{url controller='compare' action='add_article' articleID=$sBasketItem.articleID}" method="post">
                                            <button type="submit"
                                               ...
                                               class="compare--link btn btn-default btn-block phm hidden-xs hidden-sm"
