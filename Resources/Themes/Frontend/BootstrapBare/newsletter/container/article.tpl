                                ...
                                <td height="180" valign="center" style="height: 180px; text-align:center; background-color:#fff;">
                                    <div align="center" style="overflow:hidden;">
                                        <a target="_blank" href="{url controller=detail sArticle=$sArticle.articleID}" title="{$sArticle.articleName|escape}">
                                            ...
                                            {else}
                                                <img style="max-height: 160px; max-width: 160px;" src="{link file='frontend/_public/src/img/no-picture.png' fullPath}" alt="{s name="ListingBoxNoPicture" namespace="frontend/listing/box_article"}{/s}" border="0"/>
                                            {/if}
                                        </a>
                                    </div>
                                </td>
