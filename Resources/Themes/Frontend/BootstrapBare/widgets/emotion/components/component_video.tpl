{block name="widget_emotion_component_video_container"}
    <div class="emotion-video sw5-plugin"
        ...
        {block name="widget_emotion_component_video_element"}
            {strip}
                <video class="video-element sw5-plugin"
                       poster=""
        ...
        {block name="widget_emotion_component_video_cover_image"}
            {if $Data.fallback_picture}
                <a href="#play-video"
                   class="video-cover sw5-plugin"
                   style="background-image: url('{link file=$Data.fallback_picture}');">
                    <i class="video-play-icon fa fa-play sw5-plugin"></i>
                </a>
            {/if}
        {/block}
        ...
        {block name="widget_emotion_component_video_play_button"}
            {if !$Data.controls}
                <a href="#play-video"
                   class="video-play-btn sw5-plugin"
                   data-playIconCls="fa-play"
                   data-pauseIconCls="fa-pause">
                    <i class="video-play-icon fa fa-play sw5-plugin"></i>
                </a>
            {/if}
        {/block}
