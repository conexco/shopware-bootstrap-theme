...
{block name="frontend_detail_swag_custom_products_wizard"}
    ...
    {block name="frontend_detail_swag_custom_products_wizard_open_button"}
        <div class="phm pbm">
            <a href="#" class="btn btn-outline-secondary btn-block custom-products--open-wizard sw5-plugin" data-toggle="modal" data-target="#customProductsWizard" data-backdrop="static" title="{s name="detail/index/btn/configure"}Configure now{/s}">
                                                            ...
                                                            <div class="custom-product-interactive-bar mvs">
                                                                <div class="custom-products-option-actions">
                                                                    {block name="frontend_detail_swag_custom_products_options_reset_action"}
                                                                        <span class="btn btn-outline-secondary btn-xs custom-products-option-reset"
                                ...
                                <div class="row wizard-container-navigation">
                                    ...
                                    <div class="col-6 text-right">
                                        {block name="frontend_detail_swag_custom_products_wizard_modal_content_navigation_back"}
                                            <button type="button" class="btn btn-outline-secondary custom-products-navigation-btn-left sw5-plugin">
                                        ...
                                        {block name="frontend_detail_swag_custom_products_wizard_modal_content_navigation_next"}
                                            <button type="button" class="btn btn-outline-secondary custom-products-navigation-btn-right sw5-plugin">
