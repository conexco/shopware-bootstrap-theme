                            ...
                            {block name="frontend_advisor_content_sidebar_buttons"}
                                <div class="advisor-sidebar-buttons">
                                    ...
                                    {block name="frontend_advisor_content_sidebar_button_reset"}
                                        <a class="advisor-reset-advisor-btn sw5-plugin btn-block btn btn-outline-secondary" title="{s name="ResetAdvisorBtnText" namespace="frontend/advisor/main"}Reset advisor{/s}" href="{$advisorResetUrl}">
