                        ...
                        <div class="row">
                                ...
                                <div class="col-12 col-sm-6 col-lg-4">
                                    {block name="frontend_advisor_content_wizard_actions_back"}
                                        {block name="frontend_advisor_content_wizard_back_button"}
                                            <a class="advisor-wizard-back btn btn-outline-secondary btn-block mbm-xs" href="{$advisorPreviousQuestion}" title="{s name="WizardBackButtonText"}Back{/s}">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                ...
                                {block name="frontend_advisor_content_wizard_actions_reset"}
                                    <a class="advisor-reset-advisor-btn sw5-plugin btn btn-outline-secondary btn-block" title="{s name="ResetAdvisorBtnText"}Reset advisor{/s}" href="{$advisorResetUrl}">
