					...
					{block name='bundle_article_image'}
						<div class="col-md-2">
							...
							{block name='wrapper_cross_selling'}
								...
								{/if}
							{/block}
							<img src="{if $article.cover.src.0}{$article.cover.src.0}{else}{link file='frontend/_public/src/img/no-picture.png'}{/if}" alt="{$article.articleName|escape}" class="img-fluid mx-auto d-block">
						</div>
					{/block}
