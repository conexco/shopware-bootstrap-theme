						...
						{if $bundle.description}
							<div class="bundle-description mbl sw5-plugin">
								...
								{block name="panel_content_description_short"}
									<div class="teaser-text-short visible-xs">
					...
					{block name='content_products'}
						<div class="content-products-container mtm">
							...
							{block name='products_footer'}
								<div class="products-footer btn btn-default hidden sw5-plugin" data-bundleId="{$bundle.id}">{s namespace='frontend/detail/bundle/box_related' name='bundleFooterActionShow'}Bundle schlie&szlig;en{/s}</div>
							{/block}
						</div>
					{/block}
				</div>
