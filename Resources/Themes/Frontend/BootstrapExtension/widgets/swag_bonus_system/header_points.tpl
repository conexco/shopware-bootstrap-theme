                    ...
                    <ul class="dropdown-menu pam">
                        ...
                        {block name="widgets_index_actions_bonus_points"}
                            {block name="widgets_index_actions_bonus_points_link"}
                                <a class="btn btn-default btn-block" href="{url controller=BonusSystem action=points}" title="{"{s namespace="widgets/index/shop_menu" name="DisplayUserPointAccount"}Ihr Punktekonto{/s}"|escape}">
                        ...
                        {block name="widgets_index_actions_bonus_articles"}
                            {if $sBonusSystem.settings.bonus_articles_active}
                                {block name="widgets_index_actions_bonus_articles_link"}
                                    <a class="btn btn-default btn-block" href="{url controller=BonusSystem}" title="{"{s namespace="widgets/index/shop_menu" name="DisplayAllBonusArticlesTitle"}Zu den Bonus-Artikeln{/s}"|escape}">
